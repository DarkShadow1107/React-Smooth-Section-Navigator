const App = () => {
	...
	return /*#__PURE__*/ React.createElement(
		"div",
		{ className: "app-container" } /*#__PURE__*/,
		React.createElement(
			"header",
...
const Section = ({ id, title, className, bgUrl }) => {
	return /*#__PURE__*/ React.createElement(
		"section",
		{ id: id, className: `section ${className}` } /*#__PURE__*/,
		React.createElement(
			"div",
			{ className: "wrapper-outer" } /*#__PURE__*/,
			React.createElement(
				"div",
				{ className: "wrapper-inner" } /*#__PURE__*/,
				React.createElement(
					"div",
					{ className: "background", style: { backgroundImage: `url(${bgUrl})` } } /*#__PURE__*/,
